...
const PrivacyPolicy = () => {
  return (
    <div className="privacy-policy-wrapper">
      ...
      <p>Welcome to Striking Solution!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Striking Solution's Website, located at
        https://strikingsolution.com/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Striking Solution if you do not agree
        ...
        Generator and the Free Terms & Conditions Generator.
      </p>
      ...
      <h4>Cookies</h4>
      <p>
        We employ the use of cookies. By accessing Striking Solution, you agreed
        to use cookies in agreement with the Striking Solution's Privacy Policy.
      </p>
      ...
      <h4>License</h4>
      <p>
        Unless otherwise stated, Striking Solution and/or its licensors own the
        intellectual property rights for all material on Striking Solution. All
        intellectual property rights are reserved. You may access this from
        Striking Solution for your own personal use subjected to restrictions
        set in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Striking Solution</li>
        <li>Sell, rent or sub-license material from Striking Solution</li>
        <li>Reproduce, duplicate or copy material from Striking Solution</li>
        <li>Redistribute content from Striking Solution</li>
      ...
      <p>
        ...
        Striking Solution does not filter, edit, publish or review Comments
        prior to their presence on the website. Comments do not reflect the
        views and opinions of Striking Solution,its agents and/or affiliates.
        Comments reflect the views and opinions of the person who post their
        views and opinions. To the extent permitted by applicable laws, Striking
        Solution shall not be liable for the Comments or for any liability,
      ...
      <p>
        Striking Solution reserves the right to monitor all Comments and to
      ...
      <ul>
        ...
        <li>
          You hereby grant Striking Solution a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Striking Solution; and (d) the
      ...
      <p>
        ...
        e-mail to Striking Solution. Please include your name, your organization
      ...
      <ul>
        ...
        <li>
          No use of Striking Solution's logo or other artwork will be allowed
